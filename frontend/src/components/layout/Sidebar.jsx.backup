...
// VI: Sidebar navigation với menu items
  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-64 bg-gray-900 transform transition-transform duration-200
      ...
      `}>
        ...
        <div className="hidden lg:flex items-center gap-3 p-4 border-b border-gray-800">
          ...
          <div>
            <span className="text-white font-semibold">Edu Manager</span>
