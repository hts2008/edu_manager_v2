...
// VI: Sidebar navigation với menu items - Premium Design
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M11 3v18M4 10h14M4 16h10M15 6l3-3 3 3m-3-3v18"
          />
        </svg>
      ),
    ...
    <>
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-3 p-5 border-b border-white/10">
          ...
          <div>
            <span className="text-white font-bold text-lg">Edu Manager</span>
            <p className="text-gray-400 text-xs">Quản lý trung tâm</p>
          </div>
        </div>

        {/* Navigation - Enhanced */}
        <nav className="p-3 space-y-1 overflow-y-auto h-[calc(100vh-88px)] scrollbar-thin">
