...
- **Latest production deployment observed in Codex session**: `dpl_3AFgxEykCcXHhtC1A29jW37ZxJ9C` on `https://edu-manager-gules.vercel.app` after the 2026-05-25 month-bounded tuition + EduFlow UI closeout.
