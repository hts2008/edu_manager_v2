...
version: "4.0"
category: core
domain: "Legacy code analysis, refactoring, migration"
risk: medium
review_mode: paired
---
...
## Mission
Understand and modernize legacy code. Analyze existing codebases, identify patterns and anti-patterns, plan safe refactoring strategies. Migrate legacy systems incrementally with comprehensive testing.
...
- [ ] Refactoring safe (tests green throughout)
- [ ] Behavior preserved
