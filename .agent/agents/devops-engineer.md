...
version: "4.0"
category: core
domain: "CI/CD, cloud, deployment, monitoring, infrastructure"
risk: high
review_mode: paired
---
...
## Mission
Build and maintain deployment infrastructure. Set up CI/CD pipelines, configure cloud resources, implement monitoring and alerting, manage secrets, ensure zero-downtime deployments with rollback capability.
