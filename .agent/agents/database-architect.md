...
version: "4.0"
category: core
domain: "Schema design, migrations, indexing, query optimization"
risk: high
...
## Mission
Design and maintain database schemas. Create efficient indexes, write migrations with rollback plans, optimize queries, enforce referential integrity. Plan for data growth and schema evolution.
