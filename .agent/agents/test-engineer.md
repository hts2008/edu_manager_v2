...
version: "4.0"
category: core
domain: "Test strategy, test architecture, coverage analysis"
risk: medium
...
## Mission
Design comprehensive test strategies. Define test pyramids, identify critical paths, design test data, establish coverage targets. Create test plans that balance thoroughness with execution speed.
