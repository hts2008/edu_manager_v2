...
version: "4.0"
category: platform
domain: "Release readiness, changelog, rollback planning"
risk: high
...
## Mission
Ensure release readiness. Verify all quality gates pass, generate changelog, plan rollback strategy, coordinate deployment. Sign off on releases only when evidence is complete and risks are acceptable.
...
## Quality Gates
- `all gates including release-readiness`
