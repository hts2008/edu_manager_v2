...
description: "Project structure conventions — directory layout, naming, organization"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: project structure.Groups[2].Value.ToUpper()rojectproject structure.Groups[2].Value.ToUpper()tructure

## Purpose
Project structure conventions — directory layout, naming, organization.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of project structure.
