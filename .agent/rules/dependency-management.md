...
description: "Dependency rules — no unauthorized installs, audit, alternatives analysis"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: dependency management.Groups[2].Value.ToUpper()ependencydependency management.Groups[2].Value.ToUpper()anagement

## Purpose
Dependency rules — no unauthorized installs, audit, alternatives analysis.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of dependency management.
