---
name: performance
description: "Performance rules — query optimization, caching, bundle size, lazy loading"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: performance.Groups[2].Value.ToUpper()erformance

## Purpose
Performance rules — query optimization, caching, bundle size, lazy loading.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of performance.
