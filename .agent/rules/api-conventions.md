...
description: "API design rules — REST, status codes, error format, pagination"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: api conventions.Groups[2].Value.ToUpper()piapi conventions.Groups[2].Value.ToUpper()onventions

## Purpose
API design rules — REST, status codes, error format, pagination.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of api conventions.
