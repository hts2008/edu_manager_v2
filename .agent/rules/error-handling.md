---
name: error-handling
description: "Error handling rules — no silent failures, structured errors, logging"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: error handling.Groups[2].Value.ToUpper()rrorerror handling.Groups[2].Value.ToUpper()andling

## Purpose
Error handling rules — no silent failures, structured errors, logging.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of error handling.
