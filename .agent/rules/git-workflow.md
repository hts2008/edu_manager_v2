---
name: git-workflow
description: "Git workflow rules — conventional commits, branch naming, PR process"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: git workflow.Groups[2].Value.ToUpper()itgit workflow.Groups[2].Value.ToUpper()orkflow

## Purpose
Git workflow rules — conventional commits, branch naming, PR process.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of git workflow.
