---
name: database
description: "Database rules — naming, indexes, migrations, query safety"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: database.Groups[2].Value.ToUpper()atabase

## Purpose
Database rules — naming, indexes, migrations, query safety.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of database.
