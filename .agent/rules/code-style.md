---
name: code-style
description: "Code style rules — naming conventions, formatting, complexity limits"
version: "4.0"
enforcement: mandatory
human_override: "User can override with explicit justification documented in decisionLog.md"
---

# Rule: code style.Groups[2].Value.ToUpper()odecode style.Groups[2].Value.ToUpper()tyle

## Purpose
Code style rules — naming conventions, formatting, complexity limits.
...
### R1: [Primary Rule]
**Requirement**: Follow the core principle of code style.
